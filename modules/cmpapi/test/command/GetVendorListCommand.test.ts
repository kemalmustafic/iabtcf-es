...
import { VendorList, TCModel } from "didomi-iabtcf-core";
...
describe("command->GetVendorListCommand", (): void => {
  ...
  it("should return version of GVL if integer is passed", (done: () => void): void => {
    ...
    const json = require(`didomi-iabtcf-testing/lib/vendorlist/vendor-list-v${version}.json`);
  ...
  it("should cache a version of the gvl", (done: () => void): void => {
    ...
    expect(
      XMLHttpTestTools.requests.length,
